  ...
  render() {
    if (this.props.loading) {
       return (
         <CardSection>
           <Card>
           <Text style={styles.errorTextStyle}>Loading</Text>
           </Card>
        </CardSection>
      );
    }
...
export default connect(mapStateToProps, { VideoLocation, PhotoLocation, Reset })(TakePhoto);
